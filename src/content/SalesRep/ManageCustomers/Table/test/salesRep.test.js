...
import ManageSalesCustomers from '../..';
...
describe('EditUser', () => {
  ...
  beforeEach(async () => {
    ...
    wrapper = await mount(ShallowMock(<ManageSalesCustomers />, store));
  });
  ...
  //   it('Handle select on Input', () => {
  //     const event = {
  //           value:'hi'
  //         };
  //     const button = wrapper.find('select1');
...
//   });
  ...
  //   it('Handle Add button onFormSubmit', () => {
  //     const event = {
  //           target: {name:'hi'}
  //         };
