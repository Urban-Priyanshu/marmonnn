...
import CustomerPortalForecast from '../index';
...
describe('CustomerPortalForecast', () => {
  let wrapper;
  ...
  beforeEach(() => {
    ...
    wrapper = mount(<BrowserRouter> <CustomerPortalForecast /> </BrowserRouter>);
  });
  ...
  it('render component CustomerPortalForecast', () => {
    expect(wrapper.find('CustomerPortalForecast')).toBeTruthy();
  });
});