...
import CustomerPortalBlanketPo from './index';
...
describe('EditUser', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = mount(<BrowserRouter><CustomerPortalBlanketPo /></BrowserRouter>);
  });
  ...
  it('render component CustomerPortalBlanketPo', () => {
    expect(wrapper.find('CustomerPortalBlanketPo')).toBeTruthy();
  });
});