...
describe('PlaceOrderForm', () => {
  ...
  const store = mockStore({
    ...
    auth: {
      token: {
        username: 'deepanshu.tyagi@compunneldigital.com',
        token: 'eyJhbGciOiJIUzI1NiJ9..mqQ1coukBrlHoXgMq0MGGQXQISRlHYBQGXLjP6UtdtE'
      }
    },
    customerPortal: {
  ...
  beforeEach(() => {
    ...
    wrapper = shallow(ShallowMock(<PlaceOrderForm />, store));
  });
  ...
  it('render component PlaceOrderForm', () => {
    expect(wrapper.find('PlaceOrderForm')).toBeTruthy();
  });
