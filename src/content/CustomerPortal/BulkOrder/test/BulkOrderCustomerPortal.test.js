...
import CustomerPortalBulkOrder from '../index';
...
describe('CustomerPortalBulkOrder', () => {
  let wrapper;
  ...
  beforeEach(() => {
    ...
    wrapper = mount(<CustomerPortalBulkOrder/>);
  });
  ...
  it('render component CustomerPortalBulkOrder', () => {
    expect(wrapper.find('CustomerPortalBulkOrder')).toBeTruthy();
  });
});