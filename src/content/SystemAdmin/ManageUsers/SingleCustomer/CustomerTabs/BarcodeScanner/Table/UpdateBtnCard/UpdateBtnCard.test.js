...
import UpdateBtnCard from './index';
...
describe('ResetPassword', () => {
    ...
    beforeEach(() => {
        ...
        wrapper = shallow(ShallowMock(<UpdateBtnCard />, store));
    });
    ...
    it('render component UpdateBtnCard', () => {
        expect(wrapper.find('UpdateBtnCard')).toBeTruthy();
    });
