...
import BarCodeScannerConfig from '../index';
...
describe('EditUser', () => {
    ...
    beforeEach(async () => {
        ...
        wrapper = await mount(ShallowMock(<BarCodeScannerConfig />, store));
    });
    ...
    it('BarCodeScannerConfig are there', () => {
        expect(wrapper.find('BarCodeScannerConfig')).toBeTruthy();
    });
    ...
    it('Handle save button handleErrorModalClose ', () => {
    ...
    it('onClick button handleFileUpload  ', () => {
