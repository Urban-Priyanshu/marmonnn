...
import BarcodeTable from '../Table/index';
...
describe('BarcodeTable', () => {
        ...
        content: [
          {
            ...
            quantity: 23,
            uom: 'LBS',
            purchaseOrderNumber: '2133ddwq',
            specialRemarks: 'd',
            createdBy: 'Deepanshu.Tyagi@compunneldigital.com',
            createdDate: '2023-01-06T14:54:59.661+00:00',
            updatedBy: 'Owais.Naim@compunneldigital.com',
            updatedDate: '2023-01-10T08:02:26.828+00:00',
            errorsSet: null
          },
          {
            id: 4,
            ...
            quantity: 23,
            uom: 'LBS',
            purchaseOrderNumber: 'MMCSD',
            specialRemarks: 'ok',
            createdBy: 'Deepanshu.Tyagi@compunneldigital.com',
            createdDate: '2023-01-06T15:07:45.624+00:00',
            updatedBy: 'Owais.Naim@compunneldigital.com',
            updatedDate: '2023-01-10T08:05:38.062+00:00',
            errorsSet: null
          },
          {
            id: 5,
            ...
            quantity: 1,
            uom: 'PCS',
            purchaseOrderNumber: '4564298',
            specialRemarks: 'Test1',
            createdBy: 'Naveen.Alehonnappanavar@compunneldigital.com',
            createdDate: '2023-01-09T09:05:27.605+00:00',
            updatedBy: 'Naveen.Alehonnappanavar@compunneldigital.com',
            updatedDate: '2023-01-09T09:06:47.179+00:00',
            errorsSet: null
          }
        ],
        pageable: {
  ...
  beforeEach(async () => {
    ...
    wrapper = mount(ShallowMock(<BarcodeTable />, store));
  ...
  it('BarcodeTable are there', () => {
    expect('BarcodeTable').toBeTruthy();
  });
  ...
  it('Status FileUploadLink', () => {
    const button = wrapper.find('AgGridReact');
    button
      .at(0)
      .props()
      .frameworkComponents.FileUploadLink({ data: 'R' });
  });

  it('Status validOrdersLink', () => {
    const button = wrapper.find('AgGridReact');
    button
      .at(0)
      .props()
      .frameworkComponents.validOrdersLink({ data: 'R' });
  });

  it('Status invalidOrdersLink', () => {
    const button = wrapper.find('AgGridReact');
    button
      .at(0)
      .props()
      .frameworkComponents.invalidOrdersLink({ data: 'R' });
  });
  ...
  // it('Status ACtionComponent onClick', () => {
  //     const button = wrapper.find('AgGridReact');
  //     button.at(0).props().frameworkComponents.ActionComponent().props().onClick();
  // });
  it('Status handlechange', () => {
