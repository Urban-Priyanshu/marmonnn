...
import ForestOrderConfig from '../index';
...
describe('EditUser', () => {
  ...
  const store = mockStore({
    customers: {
      ...
      getForecastData: {
        ...
        poNumber: 8,
        uom: 7,
        forecastAdditionalConfigurationList: [
          {
            id: 1,
            customerNumber: 200,
            headerName: 'partname',
  ...
  beforeEach(async () => {
    ...
    wrapper = await mount(ShallowMock(<ForestOrderConfig />, store));
  });
  ...
  it('ForestOrderConfig are there', () => {
    expect('ForestOrderConfig').toBeTruthy();
  });
