...
import BulkOrderConfig from '../index';
...
describe('EditUser', () => {
  ...
  beforeEach(async () => {
    ...
    wrapper = await mount(ShallowMock(<BulkOrderConfig />, store));
  });
  ...
  it('BulkOrderConfig are there', () => {
    expect('BulkOrderConfig').toBeTruthy();
  });
  ...
  it('Handle onchange on Input', () => {
    ...
    const button = wrapper.find('.basic-multi-select11');
    act(() => button.at(0).props().onChange(event));
  });
  ...
  it('Handle onchange on Input', () => {
    ...
    const button = wrapper.find('.basic-multi-select8');
    act(() => button.at(0).props().onChange(event));
  });
  ...
  it('Handle onchange on Input', () => {
    ...
    const button = wrapper.find('.basic-multi-select9');
    act(() => button.at(0).props().onChange(event));
  });
  ...
  it('Handle onchange on Input', () => {
    ...
    const button = wrapper.find('.basic-multi-select10');
    act(() => button.at(0).props().onChange(event));
  });
